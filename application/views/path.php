	...
	<div id="container">
		...
		<p><?php echo $descrip?></p>
			<ul class="emargeur">
				<?php
					if(isset($nextPath0)) {
						?><li><a href="<?php echo base_url(); ?>index.php/Welcome/changePage/path/<?php echo $tab0 ?>"> <?php echo $nextPath0; ?> </a></li><?php
					} 
					if(isset($nextPath1)) {
						?><li><a href="<?php echo base_url(); ?>index.php/Welcome/changePage/path/<?php echo $tab1 ?>"> <?php echo $nextPath1; ?> </a></li><?php
					}
					if(isset($nextPath2)) {
						?><li><a href="<?php echo base_url(); ?>index.php/Welcome/changePage/path/<?php echo $tab2 ?>"> <?php echo $nextPath2; ?> </a></li><?php
					}
				?>
			</ul>
		</div>
